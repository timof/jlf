...
%
% \tabsplit#1#2#3
%   - #3 must be a vbox containing list of hboxes (typically containing an \halign table)
%   - #3 will be split into pages, stored as a list of vboxes in \tabsplitPages
%   - #2 is maximum vsize of first page; for other pages \vsize is the maximum
%   - #1 is the number of table header lines repeated on each page
