...
//  open_ul( 'mainmenu fullscreen a;button:button;big' );
    switch( $window ) {
      case 'menu':
        echo mainmenu_view('class=button big,ul_class=mainmenu fullscreen');
        break;
      case 'submenu_lehre':
        echo submenu_lehre_view('class=button big,ul_class=mainmenu fullscreen');
        break;
      case 'submenu_root':
        echo submenu_root_view('class=button big,ul_class=mainmenu fullscreen');
        break;
    }
//  close_ul();
