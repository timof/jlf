...
chmod 600 ./pp/basic.php
chmod 600 ./pp/inlinks.php
...
chmod 600 ./pp/windows/lehre/diplom.php
...
chmod 600 ./pp/windows/forschung/forschung.php
...
chmod 600 ./img/outlink.over.gif
...
chmod 600 ./img/letter.gif
chmod 700 ./img/il.gif
chmod 755 ./alien
...
chmod 755 ./pi
chmod 600 ./pi/cli_commands.php
chmod 755 ./pi/shared
chmod 644 ./pi/shared/common.php
chmod 644 ./pi/shared/leitvariable.php
chmod 600 ./pi/shared/basic.php
chmod 600 ./pi/shared/mysql.php
chmod 644 ./pi/shared/views.php
chmod 600 ./pi/shared/structure.php
...
chmod 700 ./pi/windows/group_view.php
...
chmod 600 ./pi/windows/groupslist.php
...
chmod 600 ./pi/windows/group_edit.php
...
chmod 700 ./cluster/js
chmod 644 ./cluster/gadgets.php
chmod 700 ./cluster/css
