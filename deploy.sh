...
chmod 755 ./code
chmod 777 ./code/leitvariable.php
chmod 600 ./code/html_new.php
chmod 777 ./code/html.php
chmod 777 ./code/head.php
chmod 777 ./code/inlinks.php
chmod 644 ./code/js.js
chmod 777 ./code/structure.php
chmod 644 ./code/maintenance.php
chmod 644 ./code/ldap.php
chmod 777 ./code/mysql.php
chmod 777 ./code/footer.php
chmod 777 ./code/tex2pdf.php
chmod 644 ./code/forms.php
chmod 644 ./code/views.php
chmod 644 ./code/logbook.php
chmod 644 ./code/common.php
chmod 777 ./code/err_functions.php
chmod 644 ./code/gadgets.php
chmod 644 ./code/logentry.php
chmod 777 ./code/index.php
chmod 777 ./code/config.php
chmod 777 ./code/global.php
chmod 777 ./code/setup.php
chmod 644 ./code/css.css
chmod 777 ./code/basic.php
chmod 777 ./code/login.php
