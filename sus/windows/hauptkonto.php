...
$fields_valuta = init_fields(
  array(
    'geschaeftsjahr' => "type=u,sources=http persistent initval,initval=$geschaeftsjahr_thread,min=$geschaeftsjahr_min,allow_null=0,set_scopes=thread"
  , 'valuta_von' => 'type=u,sources=http persistent initval,default=100,min=100,max=1299,set_scopes=thread'
  , 'valuta_bis' => 'type=u,sources=http persistent initval,default=1299,initval=1231,min=100,max=1299,set_scopes=thread'
  )
, 'global=1'
);
