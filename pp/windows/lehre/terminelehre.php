...
echo html_tag('h2', 'medskipt', we('Exams in Summer Term 2015',"Pr{$uUML}fungstermine im Sommersemester 2015") );
// 
// // open_div( 'smallskips'
...
open_table('td:smallskipt;smallskipb;qquads;solidtop');
  ...
  open_tr();
    open_td();
      open_span( 'block', 'Metzger' );
      open_span( 'block', 'Mathematik für Physiker II' );
      open_span( 'block', '' );
    open_td();
      open_span( 'block', '30.07.2015' );
      open_span( 'block', '' );
      open_span( 'block', '2.28.0.108' );
    open_td();
      open_span( 'block', '01.10.2015' );
      open_span( 'block', '' );
      open_span( 'block', '' );
  ...
  open_tr();
    open_td();
      ...
      open_span( 'block', 'Mathematische Grundlagen für Bachelor Lehramt, Teil 2' );
      open_span( 'block', 'A111, PHY-111LAS, 182' );
    open_td();
      open_span( 'block', '28.07.2015' );
  ...
  open_tr();
    open_td();
      ...
      open_span( 'block', 'Theoretische Physik III' );
      open_span( 'block', '' );
    open_td();
      open_span( 'block bold dred', '29.07.2015' );
      open_span( 'block', '10.15 Uhr' );
      open_span( 'block bold dred', '2.28.0.108' );
    open_td();
      open_span( 'block', '29.09.2015' );
      open_span( 'block', '10.00 Uhr' );
      open_span( 'block', '2.28.0.108' );
  ...
  open_tr();
    open_td();
      open_span( 'block', 'Paycha' );
      open_span( 'block', 'Mathematik für Physiker IV' );
      open_span( 'block', '' );
    open_td();
      open_span( 'block', '27.07.2015' );
      open_span( 'block', '' );
