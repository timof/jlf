...
open_div( 'smallskipb' );
  open_div( 'floatleft qqpadr bigpadb', photo_view( '/pp/fotos/tutorium3.jpg', 'Ines Mayan', 'class=teaser,format=url' ) );
  echo "
...
open_div( 'smallskipb' );
  open_div( 'floatleft qqpadr bigpadb', photo_view( '/pp/fotos/forum1.jpg', 'Ines Mayan', 'class=teaser,format=url' ) );
  echo "
